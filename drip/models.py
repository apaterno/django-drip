...
class SentDrip(models.Model):
    ...
    drip = models.ForeignKey('drip.Drip', related_name='sent_drips', on_delete=models.CASCADE, null=True)
    user = models.ForeignKey(getattr(settings, 'AUTH_USER_MODEL', 'auth.User'), related_name='sent_drips',on_delete=models.CASCADE, null=True)
